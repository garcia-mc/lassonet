...
plt.plot(Jinford[0,Jinford[7,:]==0],np.exp(-np.asarray(q0)),c='green',drawstyle='steps-post', label='steps-post',linewidth=0.5)
plt.plot(Jinford[0,Jinford[7,:]==1],np.exp(-np.asarray(q)),c='orange',drawstyle='steps-post', label='steps-post',linewidth=0.5)
